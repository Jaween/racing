...
public class MovementScript : MonoBehaviour {
    ...
    public float minRealignmentAngle;
    ...
    void AnimateMesh()
    {
        ...
        Quaternion fromRotation = meshRenderer.transform.rotation;
        Quaternion toRotation = transform.rotation;
        meshRenderer.transform.rotation = Quaternion.Slerp(
             fromRotation, toRotation, Time.deltaTime * 2.0f);
    }
    ...
    private void AnimateRoll(float angle)
    {
        ...
        Quaternion to = Quaternion.Euler(
            ...
            transform.rotation.eulerAngles.z - angle * maxRollAngle);
        
        meshRenderer.transform.rotation = 
            Quaternion.Slerp(from, to, Time.fixedDeltaTime * smoothing);
    }
